...
## Project Structure
    ...
    ├── alice_thacker_gatsb_34396  # Django project configurations
...
1. Clone this repo and `cd alice_thacker_gatsb_34396`
...
2. Clone this repo and `cd alice_thacker_gatsb_34396`
